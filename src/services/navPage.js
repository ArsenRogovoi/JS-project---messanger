...
const startNavPage = () => {
    ...
    NAV_PAGE_BACK_ARROW.removeEventListener("click", () => onChangePage(PAGES.ACCOUNT_PAGE));
    NAV_PAGE_BACK_ARROW.addEventListener("click", () => onChangePage(PAGES.ACCOUNT_PAGE));
