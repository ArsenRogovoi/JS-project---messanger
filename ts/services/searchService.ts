...
const searchChat = (numOfExistingChats: number) => {
  ...
  while (USER_PAGE_CHAT_AREA.hasChildNodes()) {
    USER_PAGE_CHAT_AREA.removeChild(USER_PAGE_CHAT_AREA.firstChild!); // non-null assertion operator
  }
